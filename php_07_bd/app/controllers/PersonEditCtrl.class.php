...
class PersonEditCtrl {
	...
	public function validateSave() {
        ...
        $this->form->phonenumber = getFromRequest("phonenumber", false);
        ...
        if ($this->form->phonenumber && strlen($this->form->phonenumber)!=9){
            getMessages()->addError("Numer telefonu musi mieć długość 9 cyfr");
        }

        if($this->form->phonenumber && !ctype_digit($this->form->phonenumber)){
            getMessages()->addError("Numer telefonu musi się składać tylko z cyfr");
        }
