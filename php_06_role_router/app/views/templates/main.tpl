	...
	<div class="navbar navbar-inverse navbar-fixed-top headroom" >
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="{$conf->app_url}"><img src="{$conf->app_url}/images/logo.png" alt="Policz swoj kredyt!"></a>
			</div>
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					...
					{else}
						<li><a {if $page=="login"}style="color:white"{/if} class="btn" href="{$conf->action_url}login">Logowanie</a></li>
					{/if}
				</ul>
			</div><!--/.nav-collapse -->
		</div>
