<?php require_once dirname(__FILE__) . '/../auth/controllers/secured_user.php'; ?>
...
<body>
	<nav>
		...
		<a href="<?php print(_APP_URL); ?>/app/auth/controllers/logout.php">Wyloguj</a>
	</nav>

	<h1>Kalkulator liczb</h1>

	<form action="<?php print(_APP_URL); ?>/app/controllers/calc.php" method="post">
